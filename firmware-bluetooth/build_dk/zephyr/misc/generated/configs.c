...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_MAX_ATTRS, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_ADDRESS_CNT, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_REPORTS_MAX, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT, 24);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 24);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_PAIRED, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_NRFX_EVT_QUEUE_SIZE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_MAX_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0xCAFE);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0xBAF2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_DEVICE_COUNT, 2);
